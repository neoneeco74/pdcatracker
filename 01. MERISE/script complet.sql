...
CREATE TABLE users(
	...
	,CONSTRAINT users_groupes_users_FK FOREIGN KEY (id_groupe) REFERENCES groupes_users(id_groupe)
	,CONSTRAINT users_services0_FK FOREIGN KEY (id_service) REFERENCES services(id_service)
)ENGINE=InnoDB;
...
CREATE TABLE unites_production(
	...
	,CONSTRAINT unites_production_categories_production_FK FOREIGN KEY (id_categorie) REFERENCES categories_production(id_categorie)
)ENGINE=InnoDB;
...
CREATE TABLE pdcas(
	...
	,CONSTRAINT pdcas_users_FK FOREIGN KEY (id_user) REFERENCES users(id_user)

	,CONSTRAINT pdcas_descriptions_pdcas0_FK FOREIGN KEY (id_description) REFERENCES descriptions_pdcas(id_description)
	
	,CONSTRAINT pdcas_produits1_FK
	FOREIGN KEY (id_produit)
	REFERENCES produits(id_produit)
	
	,CONSTRAINT pdcas_descriptions_pdcas0_AK 
...
CREATE TABLE commentaires(
	...
	,CONSTRAINT commentaires_pdcas_FK FOREIGN KEY (id_pdca) REFERENCES pdcas(id_pdca)
...
CREATE TABLE concerner(
	...
	,CONSTRAINT concerner_unites_production_FK FOREIGN KEY (id_unite) REFERENCES unites_production(id_unite)
	,CONSTRAINT concerner_pdcas0_FK FOREIGN KEY (id_pdca) REFERENCES pdcas(id_pdca)
)ENGINE=InnoDB;
...
CREATE TABLE destiner(
	...
	,CONSTRAINT destiner_pdcas_FK FOREIGN KEY (id_pdca) REFERENCES pdcas(id_pdca)
	,CONSTRAINT destiner_users0_FK FOREIGN KEY (id_user) REFERENCES users(id_user)
)ENGINE=InnoDB;
